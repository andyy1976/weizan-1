...
class DBUtil
{
    ...
    public static $TABLE_EXCHANGE_GAME = "mon_exchange_game";
    public static $TABLE_EXCHANGE_ADMIN = "mon_exchange_admin";
    public static $TABLE_EXCHANGE_RECORD = "mon_exchange_record";
