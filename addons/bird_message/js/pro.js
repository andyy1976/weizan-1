...
;(function($){
 $.fn.extend({
  "easyinsert": function(o){
   ...
   var oo = {
    remove: "<a href=\"#nogo\" class=\"remove\">-</a>",
   ...
   var allowed = true;
   //把属性拼成数组（这步不知道是否可以优化？）
   var arrCfg = new Array(o.name, o.type, o.value, o.maxlength, o.className, o.placeholder, o.required);
   //arr ==> [name, type, value, maxlength, className,placeholder,required]
   var arr = new Array();
