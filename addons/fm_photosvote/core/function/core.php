...
class Core extends WeModuleSite{
            ...
            for ($row = 1;$row <= $highestRow;$row++){
                ...
                if (is_numeric($uid)){
                    ...
                    if (empty($users)){
                        ...
                        $data = array('rid' => $rid, 'uniacid' => $uniacid, 'uid' => $uid, 'from_user' => $from_user, 'nickname' => $strs['1'], 'realname' => $strs['2'], 'photosnum' => $strs['3'], 'xnphotosnum' => $strs['4'], 'hits' => $strs['5'], 'xnhits' => $strs['6'], 'sharenum' => $strs['7'], 'zans' => $strs['8'], 'sex' => $strs['9'], 'tagid' => $cid, 'tagpid' => $pid, 'mobile' => $strs['12'], 'weixin' => $strs['13'], 'qqhao' => $strs['14'], 'email' => $strs['15'], 'address' => $strs['16'], 'photoname' => $strs['17'], 'description' => $strs['18'], 'music' => $strs['20'], 'vedio' => $strs['21'], 'status' => $strs['22'], 'createip' => getip(), 'lasttime' => time(), 'createtime' => strtotime($strs['23']),);
                        if (!empty($photosarr)){
    ...
    public function getcommentnum($rid, $uniacid, $tfrom_user){
        $num = pdo_fetchcolumn("SELECT COUNT(1) FROM " . tablename($this -> table_bbsreply) . " WHERE rid= " . $rid . " AND tfrom_user= '" . $tfrom_user . "' ");
        return $num;
    }
    ...
    public function fmvipleavel($rid, $uniacid, $tfrom_user){
        ...
        if (!empty($user)){
            ...
            $userps = pdo_fetchcolumn("SELECT COUNT(1) FROM " . tablename($this -> table_log) . " WHERE rid= " . $rid . " AND from_user= '" . $tfrom_user . "' ");
        }
    ...
    public function emotion($text){
        ...
        $str = array('(#呵呵)' => $smile_popo . '-0' . $smile_popoe, '(#哈哈)' => $smile_popo . '-30' . $smile_popoe, '(#吐舌)' => $smile_popo . '-60' . $smile_popoe, '(#啊)' => $smile_popo . '-90' . $smile_popoe, '(#酷)' => $smile_popo . '-120' . $smile_popoe, '(#怒)' => $smile_popo . '-150' . $smile_popoe, '(#开心)' => $smile_popo . '-180' . $smile_popoe, '(#汗)' => $smile_popo . '-210' . $smile_popoe, '(#泪)' => $smile_popo . '-240' . $smile_popoe, '(#黑线)' => $smile_popo . '-270' . $smile_popoe, '(#鄙视)' => $smile_popo . '-300' . $smile_popoe, '(#不高兴)' => $smile_popo . '-330' . $smile_popoe, '(#真棒)' => $smile_popo . '-360' . $smile_popoe, '(#钱)' => $smile_popo . '-390' . $smile_popoe, '(#疑问)' => $smile_popo . '-420' . $smile_popoe, '(#阴险)' => $smile_popo . '-450' . $smile_popoe, '(#吐)' => $smile_popo . '-480' . $smile_popoe, '(#咦)' => $smile_popo . '-510' . $smile_popoe, '(#委屈)' => $smile_popo . '-540' . $smile_popoe, '(#花心)' => $smile_popo . '-570' . $smile_popoe, '(#呼~)' => $smile_popo . '-600' . $smile_popoe, '(#笑眼)' => $smile_popo . '-630' . $smile_popoe, '(#冷)' => $smile_popo . '-660' . $smile_popoe, '(#太开心)' => $smile_popo . '-690' . $smile_popoe, '(#滑稽)' => $smile_popo . '-720' . $smile_popoe, '(#勉强)' => $smile_popo . '-750' . $smile_popoe, '(#狂汗)' => $smile_popo . '-780' . $smile_popoe, '(#乖)' => $smile_popo . '-810' . $smile_popoe, '(#睡觉)' => $smile_popo . '-840' . $smile_popoe, '(#惊哭)' => $smile_popo . '-870' . $smile_popoe, '(#升起)' => $smile_popo . '-900' . $smile_popoe, '(#惊讶)' => $smile_popo . '-930' . $smile_popoe, '(#喷)' => $smile_popo . '-960' . $smile_popoe, '(#爱心)' => $smile_popo . '-990' . $smile_popoe, '(#心碎)' => $smile_popo . '-1020' . $smile_popoe, '(#玫瑰)' => $smile_popo . '-1050' . $smile_popoe, '(#礼物)' => $smile_popo . '-1080' . $smile_popoe, '(#彩虹)' => $smile_popo . '-1110' . $smile_popoe, '(#星星月亮)' => $smile_popo . '-1140' . $smile_popoe, '(#太阳)' => $smile_popo . '-1170' . $smile_popoe, '(#钱币)' => $smile_popo . '-1200' . $smile_popoe, '(#灯泡)' => $smile_popo . '-1230' . $smile_popoe, '(#茶杯)' => $smile_popo . '-1260' . $smile_popoe, '(#蛋糕)' => $smile_popo . '-1290' . $smile_popoe, '(#音乐)' => $smile_popo . '-1320' . $smile_popoe, '(#haha)' => $smile_popo . '-1350' . $smile_popoe, '(#胜利)' => $smile_popo . '-1380' . $smile_popoe, '(#大拇指)' => $smile_popo . '-1410' . $smile_popoe, '(#弱)' => $smile_popo . '-1440' . $smile_popoe, '(#OK)' => $smile_popo . '-1470' . $smile_popoe,);
    ...
    public function checkoauth2($rid, $oauthopenid, $oauthunionid = '', $fromuser = ''){
        global $_W;
        $cfg = $this -> module['config'];
        if ($_W['account']['level'] == 4){
            $appid = $_W['account']['key'];
    ...
    public function GetOauth($do, $uniacid, $fromuser, $rid, $gfrom_user = ''){
        global $_W;
        $cfg = $this -> module['config'];
        ...
        pdo_update($this -> table_reply_display, array('hits' => $rdisplay['hits'] + 1), array('rid' => $rid));
        ...
        if ($cfg['oauthtype'] == 3){
            ...
            if ($cfg['oauthtype'] == 1){
                if ($do != 'shareuserview' && $do != 'shareuserdata' && $do != 'treg' && $do != 'tregs' && $do != 'tvotestart' && $do != 'tbbs' && $do != 'tbbsreply' && $do != 'saverecord' && $do != 'saverecord1' && $do != 'subscribeshare' && $do != 'pagedata' && $do != 'listentry' && $do != 'code' && $do != 'reguser' && $do != 'phdata'){
                ...
                if ($cfg['oauthtype'] == 2){
                    ...
                    if (empty($_COOKIE["user_oauth2_openid"]) || empty($unionid)){
                        if ($do != 'shareuserview' && $do != 'shareuserdata' && $do != 'treg' && $do != 'tregs' && $do != 'tvotestart' && $do != 'tbbs' && $do != 'tbbsreply' && $do != 'saverecord' && $do != 'subscribeshare' && $do != 'pagedata' && $do != 'pagedatab' && $do != 'listentry' && $do != 'code' && $do != 'reguser' && $do != 'phdata'){
                            $this -> checkoauth2($rid, $_COOKIE["user_oauth2_openid"], $unionid, $fromuser);
                        }
                    }
                }else{
                    if (empty($_COOKIE["user_oauth2_openid"])){
                        if ($do != 'shareuserview' && $do != 'shareuserdata' && $do != 'treg' && $do != 'tregs' && $do != 'tvotestart' && $do != 'tbbs' && $do != 'tbbsreply' && $do != 'saverecord' && $do != 'subscribeshare' && $do != 'pagedata' && $do != 'pagedatab' && $do != 'listentry' && $do != 'code' && $do != 'reguser' && $do != 'phdata'){
                            $this -> checkoauth2($rid, $_COOKIE["user_oauth2_openid"], '', $fromuser);
                        }
                    }
                }
        ...
        $usersinfo = array('from_user' => $from_user, 'unionid' => $unionid, 'nickname' => $nickname, 'follow' => $follow, 'avatar' => $avatar, 'sex' => $sex,);
        return $usersinfo;
    }
