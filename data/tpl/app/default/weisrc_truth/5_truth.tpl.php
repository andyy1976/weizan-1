...
<head>
    ...
    <meta name="wumi-weixin-share-img-url" content="<?php echo RES;?>images/truth.jpg">
    <meta name="wumi-weixin-share-desc" content="想知道我的真心话吗？快和我交换秘密，来场真心话大冒险吧！">
    <title>和朋友交换真心话</title>
    <link rel="stylesheet" href="<?php echo RES;?>css/truth.default.css?v=1" type="text/css" media="screen" />
</head>
<body>
    <!-- 选问题 -->
    <div id="questions">
        <div class="section">
            ...
            <div class="list">
                <ul>
                    ...
                    <?php  if(!empty($replylist[$item['id']]['id'])) { ?>
                    <a href="<?php  echo $this->createMobileUrl('question', array('id' => $item['id']), true)?>">
                    <?php  } ?>
                    <li class="j-question" data-q="<?php  echo $item['title'];?>">
                        <div class="q">
                            <p><?php  if(!empty($replylist[$item['id']])) { ?>
                                [已答]
                               <?php  } ?><?php  echo $item['title'];?></p>
                        </div>
...
<script type="text/javascript" src="<?php echo RES;?>js/truth.default.js"></script>
<!--<script type="text/javascript" src="<?php echo RES;?>js/question.js"></script>-->
<script type="text/javascript">
    !function(t) {
        ...
        var i = '<input type="text" class="input custom-question j-question-string" placeholder="想与朋友交换的真心话题..."/>', s = '<div class="another j-change"><label>换个问题</label></div>', e = '<div class="ajax-loading-layer"><img src="<?php echo RES;?>images/ajax_loading.gif"/></div>', o = [], r = ($("#theme"), $("#questions")), a = $("#mytruth");
        t.question = {
            setInit: function(t) {
                return o = t, this
            },
