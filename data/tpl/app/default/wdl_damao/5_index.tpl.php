...
<head>
    ...
    <meta name="viewport" content="initial-scale=1, user-scalable=no, minimum-scale=1.0, maximum-scale=1.0, width=device-width,target-densitydpi=device-dpi"/>
	  <script type="text/javascript" src="../addons/wdl_damao/template/mobile/js/jquery.min.js"></script>
    <script type="text/javascript" src="../addons/wdl_damao/template/mobile/js/createjs.js"></script>
    ...
    .loading {background-image: url("../addons/wdl_damao/template/mobile/images/loding.gif");
    ...
    .welcome-bg {position:absolute;top:0;left:0;right:0;bottom:0; background: url(../addons/wdl_damao/template/mobile/images/bing.jpg) center center no-repeat; background-size:100% 100%; opacity: .4;overflow: hidden;}
    ...
    .block{background-image:url(../addons/wdl_damao/template/mobile/images/em.jpg);}
    .t1,.t2,.t3,.t4,.t5 { background-size:auto 98%;background-image:url(../addons/wdl_damao/template/mobile/images/tt0.jpg);}
    
    .t3,.t4 {background-image:url(../addons/wdl_damao/template/mobile/images/tt1.jpg);}
    .t5 {background-image:url(../addons/wdl_damao/template/mobile/images/tt2.jpg);}
    
    .tt1,.tt2,.tt3,.tt4,.tt5 { background-size:auto 96%;background-image:url(../addons/wdl_damao/template/mobile/images/jiao.jpg);}
    .tt1,.tt2{background-image:url(../addons/wdl_damao/template/mobile/images/j1.jpg);}
    .tt3,.tt4{background-image:url(../addons/wdl_damao/template/mobile/images/j2.jpg);}
    ...
    .bad {background-color:#000;background-size:90%;background-image:url(../addons/wdl_damao/template/mobile/images/bad.jpg); -webkit-animation: flash .2s 3;animation: flash .2s 3;}
...
<body>
	<script type="text/javascript">
	window.shareData = {
      "imgUrl": "../addons/wdl_flyer/template/mobile/dbsjm.jpg",
	...
	function gameInit(){
        createjs.Sound.registerSound( {src:"../addons/wdl_damao/template/mobile/audio/nima.mp3", id:"err"} );
        createjs.Sound.registerSound( {src:"../addons/wdl_damao/template/mobile/audio/end.mp3", id:"end"} );
        createjs.Sound.registerSound( {src:"../addons/wdl_damao/template/mobile/audio/type.mp3", id:"tap"} );
		gameRestart();
	}
	...
	<div id="GameScoreLayer" class="BBOX SHADE bgc1" style="display:none;">
      ...
      <span id="GameScoreLayer-score" style="margin-bottom:1em;">得分</span>
			...
			<br/>
      <a class="bt" href="http://v2.addons.012wz.com/web/index.php?c=store&a=author&uid=91001">更多游戏</a>
			<br/> 
...
<div style="padding:40% 5%;text-align:center;"> 
	...
	<div id="share-wx"><p style="text-align: right; padding-left: 10px;"><img src="../addons/wdl_damao/template/mobile/images/2000.png" id="share-wx-img"  style="width:100%;"></p></div>
