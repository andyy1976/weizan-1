    ...
    <script type="text/template" id="descriptionsTemplate">
        <div class="descriptions">
            ...
            <div class="main">
                <div class="inner">
                    <ul>
                        <?php  if(is_array($words)) { foreach($words as $w) { ?>
						<li>
							<?php  if($reply['level']==0) { ?>
							<a class="btn btn-description" href="#description/<?php  echo $w['id'];?>/<?php  echo $w['word'];?>"><?php  echo $w['word'];?></a>
							<?php  } else { ?>
							<a class="btn btn-description" href="<?php  echo $this->createMobileUrl('index', array('wid'=>$w['id'], 'op'=>'drawword', 'rid'=>$rid))?>"><?php  echo $w['word'];?></a>
							<?php  } ?>
						</li>
						<?php  } } ?>
                    </ul>
...
wx.ready(function () {
	var shareData = {
		...
		desc: '<?php  echo $reply['sharedescription'];?>',
		link: '<?php  echo $wx['url'];?>',
		imgUrl: '<?php  echo $_W['attachurl'];?><?php  echo $reply['sharecover'];?>',
