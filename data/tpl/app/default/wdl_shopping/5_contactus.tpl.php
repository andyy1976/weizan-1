	...
	<div class="tab-content">
		<div class="tab-pane active" id="tab1">
			...
			<?php  if(!empty($cfg['logo'])) { ?>
				<img src="<?php  echo $cfg['logo'];?>" width="100%" />
			<?php  } ?>
...
<?php (!empty($this) && $this instanceof WeModuleSite) ? (include $this->template('footer-base', TEMPLATE_INCLUDEPATH)) : (include template('footer-base', TEMPLATE_INCLUDEPATH));?>
