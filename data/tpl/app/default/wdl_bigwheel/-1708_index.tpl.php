...
<div class="main">
    ...
    <div class="content">
        ...
        <div class="box">
            ...
            <div class="Detail">
                <p>你中了：
                    <span class="red" id="prizetype"><?php  if(empty($awardone['name'])) { ?>感谢参与<?php  } else { ?><?php  echo $awardone['name'];?> -  <?php  echo $awardone['description'];?><?php  } ?></span>
                </p>

                <p style="display:none">兑奖<?php  echo $reply['sn_rename'];?>：
                    <span class="red" id="sncode"><?php  echo $awardone['award_sn'];?></span>
                </p>
                ...
                <p>
                    <input name="tel" class="px" id="tel" value="<?php  echo $_W['fans']['mobile'];?>" type="text" placeholder="用户请输入您的<?php  echo $reply['tel_rename'];?>">
                </p>
...
<div class="boxcontent boxyellow">
    <div class="box">
        ...
        <div class="Detail">
            ...
            <p class="green">活动时间: <?php  echo date('Y-m-d H:i',$reply['starttime']);?> 至 <?php  echo date('Y-m-dH:i',($reply['endtime']+86399));?></p>
...
<div class="boxcontent boxwhite">
    <div class="box">
        ...
        <div class="Detail">
            ...
            <p>你中了：<span class="red" id="name"><?php  if(empty($row['name'])) { ?>感谢参与<?php  } else { ?><?php  echo $row['name'];?>  -  <?php  echo $row['description'];?> <?php  } ?></span>
            </p>
