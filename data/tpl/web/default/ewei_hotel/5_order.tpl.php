			...
			<form action="./index.php" method="get" class="form-horizontal" role="form">
				...
				<div class="form-group">
					...
					<div class="col-sm-4 col-xs-12">
						<input class="form-control" name="hoteltitle"  type="text" value="<?php  if(!empty($hotel)) { ?><?php  echo $hotel['title'];?><?php  } else { ?><?php  echo $_GPC['hoteltitle'];?><?php  } ?>" placeholder="酒店名称">
					</div>
					<div class="col-sm-4 col-xs-12">
		...
		<table class="table table-hover">
			...
			<tr>
				...
				<td>
					...
					<?php  } else { ?>
					<?php  if($row['status'] == 0) { ?><span class="label label-info"><?php  if($row['paytype']=='3') { ?>待付款<?php  } else { ?>已支付，等待确认<?php  } ?></span><?php  } ?>
