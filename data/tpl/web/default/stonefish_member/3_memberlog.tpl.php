...
<div class="alert alert-info">
	<a href="<?php  echo $this->createWebUrl('memberlog');?>" title="粉丝统计" class="btn btn-<?php  if(empty($acid)) { ?>danger<?php  } else { ?>primary<?php  } ?>"><i class="fa fa-bar-chart-o"></i> 总会员统计</a>
	<?php  if(is_array($ids)) { foreach($ids as $idsname) { ?>
	<a href="<?php  echo $this->createWebUrl('memberlog',array('acid' => $idsname['id']));?>" title="<?php  echo $acid_arr[$idsname]['name'];?>之粉丝统计" style="margin-left:15px;" class="btn btn-<?php  if($acid==$idsname['id']) { ?>danger<?php  } else { ?>primary<?php  } ?>"><i class="fa fa-bar-chart-o"></i> <?php  echo $acid_arr[$idsname]['name'];?></a>
	<?php  } } ?>
</div>
<?php  } ?>
<style>
...
<div class="panel panel-default">
	...
	<div class="panel-body">
		<div class="account-stat-num row">
			<div>新会员人数<span><?php  echo $add_num;?></span></div>
			<div>取消会员人数<span><?php  echo $cancel_num;?></span></div>
			<div>净增会员人数<span><?php  echo $jing_num;?></span></div>
			<div>累积会员人数<span><?php  echo $total_num;?></span></div>
		</div>
	</div>
</div>
<div class="panel panel-default">
	...
	<div class="panel-body">
		<div class="account-stat-num row">
			<div>新会员人数<span><?php  echo $today_add_num;?></span></div>
			<div>取消会员人数<span><?php  echo $today_cancel_num;?></span></div>
			<div>净增会员人数<span><?php  echo $today_jing_num;?></span></div>
			<div>累积会员人数<span><?php  echo $today_total_num;?></span></div>
		</div>
	</div>
</div>
