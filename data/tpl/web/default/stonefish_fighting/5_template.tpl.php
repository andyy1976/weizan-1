...
<style>
/*listShow-模板列表*/
.u-listShow { width: 222px; border-radius:6px; overflow: hidden; float:left; margin:10px;}
			...
			<div class="item">
				<div class="u-listShow f-card">
					...
					<div class="item-bottom s-bg-fff" style="">
						...
						<div class="con">
						<p>by stonefish</p>
						<strong class="f-tr"><?php  if($row['uniacid']) { ?><a href="<?php  echo $this->createWeburl('templatedel',array('id'=>$row['id']))?>">【删除】</a><?php  } else { ?>不可删除<?php  } ?></strong>
						</div>
					</div>
				</div>
			</div>
