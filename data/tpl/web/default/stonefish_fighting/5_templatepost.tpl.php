...
<div class="main">
	<ul class="nav nav-tabs">
        ...
        <li<?php  if($_GPC['do'] == 'templatepost' || $_GPC['do'] == '') { ?> class="active"<?php  } ?>><a href="<?php  echo url('site/entry/templatepost',array('m'=>'stonefish_fighting'));?>"><i class="fa fa-plus"></i> 添加活动模板</a></li>
    ...
    <div class="panel panel-default">
	    <div class="panel-heading">模板配置</div>
	        <div class="panel-body">
				...
				<div class="form-group">
					<label class="col-xs-12 col-sm-3 col-md-2 control-label">导航/选项背景色</label>
					<div class="col-sm-9">
						<?php  echo tpl_form_field_color('navcolor', $item['navcolor'])?>
					</div>
				</div>
				<div class="form-group">
					<label class="col-xs-12 col-sm-3 col-md-2 control-label">导航/选项文字色</label>
					<div class="col-sm-9">
				...
				<div class="form-group">
					<label class="col-xs-12 col-sm-3 col-md-2 control-label">标题/兑奖框背景色</label>
					<div class="col-sm-9">
						<?php  echo tpl_form_field_color('awardcolor', $item['awardcolor'])?>
					</div>
				</div>
				<div class="form-group">
					<label class="col-xs-12 col-sm-3 col-md-2 control-label">标题/兑奖框文字色</label>
					<div class="col-sm-9">
		...
		<div class="form-group">
		    <div class="col-sm-12">
				...
				<?php  } else { ?>
				    <input type="hidden" name="fuzhi" value="yes">
					<button type="submit" class="btn btn-primary col-lg-3" name="submit" value="复制后修改">复制后修改</button>
				<?php  } ?>				
