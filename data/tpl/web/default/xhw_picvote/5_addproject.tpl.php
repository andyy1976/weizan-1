                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-8 col-xs-12">
                        <input type="text" class="form-control" placeholder="" name="follow_url" value="<?php  echo $subject['follow_url'];?>">
                         <div class="help-block">建议做一条引导关注的图文素材。例：<a href="http://www.dwz.cn/012wz" target="_black">点击查看</a></div>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-sm-8 col-xs-12">
                        <input type="text" class="form-control" placeholder="" name="rule_url" value="<?php  echo $subject['rule_url'];?>">
                         <div class="help-block">建议做一条朋友圈人气榜规则说明的图文素材。例：<a href="http://www.dwz.cn/012wz" target="_black">点击查看</a></div>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-sm-8 col-xs-12">
                        <input type="text" class="form-control" placeholder="" name="submit_url" value="<?php  echo $subject['submit_url'];?>">
                         <div class="help-block">建议做一条活动介绍的图文素材，可详细说明规则和奖品等细节。例：<a href="http://www.dwz.cn/012wz" target="_black">点击查看</a></div>
                    </div>
                </div>
                <div class="form-group">
