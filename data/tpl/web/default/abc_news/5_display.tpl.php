						...
						<div class="alert">
							...
							<div class="form-group">
								<div class="col-sm-offset-4 col-md-offset-3 col-lg-offset-2 col-xs-12 col-sm-8 col-md-9 col-lg-10">
									<label class="checkbox-inline">
										<input type="checkbox" value="data" class="detail-switch" <?php  if(!empty($li['content'])) { ?>checked<?php  } ?>/> 是否编辑图文详情
									</label>
							...
							<div class="form-group">
								...
								<div class="col-sm-9 col-xs-12">
									<textarea class="form-control richtext" name="contents[]"><?php  echo $li['content'];?></textarea>
								</div>
							</div>
							<div class="form-group">
