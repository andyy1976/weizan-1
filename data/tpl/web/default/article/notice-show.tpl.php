...
<div class="xiaoyu_container cl">
        <h1 class="color-green z"><a href="<?php  echo url('article/notice-show/list');?>">公告动态</a></h1>
        <ul class="y breadcrumb">
        <li><a href="./" title="首页">首页</a> <span class="divider">/</span></li>
		<li><a href="<?php  echo url('article/notice-show/list');?>">公告列表</a><span class="divider">/</span></li>
...
<div class="xiaoyu_container cl">
	...
	<?php  if(is_array($data)) { foreach($data as $da) { ?>
		...
		<div class="col-md-5">
        <a href="<?php  echo url('article/notice-show/detail', array('id' => $da['id']));?>" target="_blank"><img src="<?php  echo $_W['siteroot'];?>/attachment/<?php  echo $da['thumb'];?>" alt="<?php  echo $da['title'];?>" class="img-responsive" /></a>
		</div>    
		<div class="col-md-7">
		<h2> <a href="<?php  echo url('article/notice-show/detail', array('id' => $da['id']));?>" target="_blank" ><?php  echo $da['title'];?></a></h2>
        <ul class="list-unstyled list-inline blog-info cl">
            <li><i class="fa fa-calendar"></i> <?php  echo date('Y-m-d', $da['createtime']);?></li>  
			<li><i class="fa fa-tags"></i><a href="<?php  echo url('article/notice-show/detail', array('id' => $da['id']));?>">&nbsp;作者: <?php  echo $da['author'];?></a></li>	
			<li><i class="fa fa-tags"></i><a href="<?php  echo url('article/notice-show/detail', array('id' => $da['id']));?>">&nbsp;阅读: <?php  echo $da['click'];?> 次</a></li>				
        </ul>
        <p><?php  echo cutstr_html($da['content'],'108');?></p>
        <p class="xiaoyu_readmore"><a href="<?php  echo url('article/notice-show/detail', array('id' => $da['id']));?>" target="_blank" class="btn-u btn-u-sm">Read More <i class="fa fa-angle-double-right margin-left-5"></i></a></p>
		</div>    
		</div>
	<?php  } } ?>
 ...
 <div class="y pph xiaoyu_view_sd"> 
   <div class="col-md-3"> 
    ...
    <div class="posts margin-bottom-40"> 
	 ...
	 <div class="headline headline-md"><h2>最新公告</h2></div>
	 <?php  if(is_array($data)) { foreach($data as $da) { ?>
		<dl class="dl-horizontal">
			<dt><a href="<?php  echo url('article/notice-show/detail', array('id' => $da['id']));?>"><img  src="<?php  echo $_W['siteroot'];?>/attachment/<?php  echo $da['thumb'];?>"></a></dt>
			<dd>
			<p><a href="<?php  echo url('article/notice-show/detail', array('id' => $da['id']));?>" target="_blank"><?php  echo $da['title'];?></a></P>
			</dd>
		</dl>
	<?php  } } ?>
	 </div>
...
<?php  if(is_array($categroys)) { foreach($categroys as $categroy) { ?>		
         <li><a href="<?php  echo url('article/notice-show/list', array('cateid' => $categroy['id']));?>"><?php  echo $categroy['title'];?></a></li>           
<?php  } } ?>    
        </ul> 
       </div> 
      </div> 
...
<div class="xiaoyu_container cl">
	<div class="mn xiaoyu_mn_view2">
		...
		<div class="h hm">
		<h1 class="ph" style="padding-top: 15px;" ><?php  echo $notice['title'];?></h1>
		<p class="xg1">
		<?php  echo date('Y-m-d H:i', $notice['createtime']);?><span class="pipe">|</span>
		作者: <em id="_viewnum"><?php  echo $notice['author'];?></em><span class="pipe">|</span>
		查看: <em id="_viewnum"><?php  echo $notice['click'];?> 次</em><span class="pipe">|</span>
		</p>
		</div>
