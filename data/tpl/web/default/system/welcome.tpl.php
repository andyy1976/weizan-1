...
<?php  if($_W['isfounder']) { ?>
	<div class="clearfix" style="margin-bottom:5em;">
		...
		<h5 class="page-header">测试</h5>
        <div class="clearfix">
            <a href="<?php  echo url('user/bandwechat');?>" class="tile img-rounded">
                <i class="fa fa-weixin"></i>
                <span>微信绑会员卡</span>
            </a>
            </a>
            <a href="<?php  echo url('user/opencard&gd=gd');?>" class="tile img-rounded">
                <i class="fa fa-legal"></i>
                <span>会员卡开通</span>
            </a>
            <a href="<?php  echo url('user/usermsg&gd=gd');?>" class="tile img-rounded">
                <i class="fa fa-user"></i>
                <span>会员信息</span>
            </a>
            <a href="<?php  echo url('user/updatepwd&gd=gd');?>" class="tile img-rounded">
                <i class="fa fa-refresh"></i>
                <span>修改密码</span>
            </a>
            <a href="<?php  echo url('user/usermsg&do=balancescore&gd=gd');?>" class="tile img-rounded">
                <i class="fa fa-file"></i>
                <span>余额及积分</span>
            </a>
            <a href="<?php  echo url('user/usermsg&do=coupon&gd=gd');?>" class="tile img-rounded">
                <i class="fa fa-file"></i>
                <span>折扣券</span>
            </a>
            <a href="<?php  echo url('user/usermsg&do=deal&gd=gd');?>" class="tile img-rounded">
                <i class="glyphicon glyphicon-list-alt"></i>
                <span>交易记录</span>
            </a>
	</div>
<?php  } else { ?>
	<div class="clearfix" style="margin-bottom:5em;"><?php  var_dump($_W) ?>
		<h5 class="page-header">公众号</h5>
		<div class="clearfix">
			<a href="<?php  echo url('account/display');?>" class="tile img-rounded">
				<i class="fa fa-comments"></i>
