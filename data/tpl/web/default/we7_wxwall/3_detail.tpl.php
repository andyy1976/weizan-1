...
<div class="side_div">
	...
	<?php  if($_W['uid']) { ?><div class="side_item"><a href="javascript:;" onclick="wxwall.prevPage()">上一条</a></div><?php  } ?>
	<?php  if($_W['uid']) { ?><div class="side_item"><a href="javascript:;" onclick="wxwall.nextPage()">下一条</a></div><?php  } ?>
...
var wxwall = {
	...
	'txwall' : {
		'status' : 1,
		'lastmsgtime' : '<?php  echo $_W['timestamp'];?>',
		'lastuser' : '',
	},
	'init' : function() {
		var $this = this;
	...
	'buildItem' : function(message) {
		...
		var html =
					'<div class="talkList" id="msg_'+message['id']+'" style="display:none; height:auto;">' +
						'<div class="userPic">' +
							'<img src="'+message['avatar']+'">' +
							'<span class="userName">'+message['nickname']+'</span>' +
						'</div>' +
						'<div class="msgBox">' +
							'<span class="msgCnt" style="font-size:' + font_size + 'px;line-height:' + parseInt(font_size+8) + 'px;">' +
