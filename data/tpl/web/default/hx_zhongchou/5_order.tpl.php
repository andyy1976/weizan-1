...
<div class="panel panel-info">
	...
	<div class="panel-body">
		<form action="./index.php" method="get" class="form-horizontal" role="form" id="form1">
			...
			<div class="form-group">
				<label class="col-xs-12 col-sm-2 col-md-2 col-lg-1 control-label">项目选择</label>
				<div class="col-sm-8 col-lg-9 col-xs-12">
					<?php  echo tpl_form_field_category_2level('project', $projects, $pitems, $pid, $iid);?>
				</div>
			</div>
			<div class="form-group">
		...
		<div class="panel panel-default">
			...
			<div class="panel-body">
				<div class="form-group">
					...
					<div class="col-sm-9 col-xs-12">
						<p class="form-control-static"><?php  echo $item['user']['username'];?></p>
					</div>
				</div>
				<div class="form-group">
			...
			<div class="panel-body table-responsive">
				<table class="table table-hover">
					...
					<tr>
						...
						<th style="width:100px;">项目名称</th>
						<th style="width:150px;">支持金额</th>
						<th style="width:150px;">回报属性</th>
						<th style="width:250px;">回报详情</th>
					...
					<tr>
						...
						<td>
							<?php  if($category[$project['pcate']]['name']) { ?>
							<span class="text-error">[<?php  echo $category[$project['pcate']]['name'];?>] </span><?php  } ?><?php  if($children[$project['pcate']][$project['ccate']]['1']) { ?>
							<span class="text-info">[<?php  echo $children[$project['pcate']][$project['ccate']]['1'];?>] </span>
							<?php  } ?>
							<?php  echo $project['title'];?>
						</td>
						<td><?php  echo $item['item_price'];?>元</td>
						<td><span class="label label-info"><?php  if($project['type'] == 1) { ?>实体商品<?php  } else { ?>虚拟商品<?php  } ?></span></td>
