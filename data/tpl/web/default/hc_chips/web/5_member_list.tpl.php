...
<ul class="nav nav-tabs">
	<li><a href="<?php  echo $this->createWebUrl('member',array('op'=>'post'));?>">添加粉丝</a></li>
		...
		<form action="" method="post" class="form-horizontal">
			...
			<div class="form-group">
				...
				<div class="col-sm-8 col-lg-9">
					<input type="text" name="realname" class="form-control" value="<?php  echo base64_decode($sort['realname'])?>" />
				</div>
			</div>
			<div class="form-group">
...
<div class="panel panel-default">
	<table class="table table-hover">
		...
		<tr>
			<td><?php  echo base64_decode($item['realname'])?></td>
			...
			<td>
				<a class="btn btn-default btn-sm" href="<?php  echo $this->createWebUrl('member', array('id' => $item['id'], 'op' => 'post'))?>" title="编辑"><i class="fa fa-pencil"></i></a>
