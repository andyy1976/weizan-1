	...
	<div class="panel-body">
		<?php  if($prize) { ?>
			...
			<div class="form-group">
                ...
                <div class="col-sm-9">
					<label class="radio-inline">
						<input type="radio" name="prizetype[<?php  echo $item['id'];?>]" value="physical"<?php  if($item['prizetype']=='physical') { ?> checked="checked"<?php  } ?> onclick="$('#p_name_<?php  echo $item['id'];?>').html('真实');"/>真实物品
					</label>
					<label class="radio-inline">
						<input type="radio" name="prizetype[<?php  echo $item['id'];?>]" value="virtual"<?php  if($item['prizetype']=='virtual') { ?> checked="checked"<?php  } ?> onclick="$('#p_name_<?php  echo $item['id'];?>').html('虚拟');"/>虚拟物品
					</label>
					<?php  if(is_array($creditnames)) { foreach($creditnames as $key => $credit) { ?>
					<label class="radio-inline">
						<input type="radio" name="prizetype[<?php  echo $item['id'];?>]" value="<?php  echo $key;?>"<?php  if($item['prizetype']==$key) { ?> checked="checked"<?php  } ?> onclick="$('#p_name_<?php  echo $item['id'];?>').html('<?php  echo $credit;?>');"/>会员（<?php  echo $credit;?>）
					</label>
					<?php  if($item['prizetype']==$key) { ?><?php  $credit_name = $credit;?><?php  } ?>
					<?php  } } ?>
					<label class="radio-inline">
						<input type="radio" name="prizetype[<?php  echo $item['id'];?>]" value="againprize"<?php  if($item['prizetype']=='againprize') { ?> checked="checked"<?php  } ?> onclick="$('#p_name_<?php  echo $item['id'];?>').html('再来一次');"/>再来一次
					</label>
					<label class="radio-inline">
						<input type="radio" name="prizetype[<?php  echo $item['id'];?>]" value="spaceprize"<?php  if($item['prizetype']=='spaceprize') { ?> checked="checked"<?php  } ?> onclick="$('#p_name_<?php  echo $item['id'];?>').html('空奖');"/>空奖
					</label>					
					<?php  if($item['fans']) { ?><span style="float:right;" class="btn btn-danger">无法删除，已有粉丝中此奖品</span><?php  } else { ?><span style="float:right;"><a class="btn btn-danger" href="<?php  echo $item['delete_url'];?>">删除此奖品</a></span><?php  } ?>
					<div class="help-block">奖品类型为会员（积分）、会员（余额）等会员积分类型时，价值为增送的积分或余额等积分/余额值 <span style='color:red'>空奖不保存记录</span></div>
				</div>
            </div>					
			<div class="form-group">
                <label class="col-xs-12 col-sm-2 col-md-2 control-label"><span style='color:red'>*</span> <span id="p_name_<?php  echo $item['id'];?>"><?php  if($item['prizetype']=='physical') { ?>真实<?php  } ?><?php  if($item['prizetype']=='virtual') { ?>虚拟<?php  } ?><?php  echo $credit_name;?></span>价值</label>
                <div class="col-sm-4">
                    <input class="form-control" type="text" value="<?php  echo $item['prizevalue'];?>" name="prizevalue[<?php  echo $item['id'];?>]">
                </div>
				<!--
				<label class="col-xs-12 col-sm-2 col-md-2 control-label">助力人次</label>
                <div class="col-sm-3">
                    <div class="input-group">
                        <input class="form-control" type="text" value="<?php  echo $item['break'];?>" name="break[<?php  echo $item['id'];?>]">
			...
			<div class="form-group">
                ...
                <div class="col-sm-4">
                    <input class="form-control" type="text" value="<?php  echo $item['prizerating'];?>" name="prizerating[<?php  echo $item['id'];?>]">
                </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-3">
                    <div class="input-group">
                        <input class="form-control" type="text" value="<?php  echo $item['probalilty'];?>" name="probalilty[<?php  echo $item['id'];?>]">
			...
			<div class="form-group">
                ...
                <div class="col-sm-4">
                    <div class="input-group">
						...
						<input class="form-control" type="text" value="<?php  echo $item['prizeren'];?>" name="prizeren[<?php  echo $item['id'];?>]">
                ...
                <div class="col-sm-3">
                    <div class="input-group">
						...
						<input class="form-control" type="text" value="<?php  echo $item['prizeday'];?>" name="prizeday[<?php  echo $item['id'];?>]">
                        <span class="input-group-addon">个 0为不限制</span>
                    </div>
                </div>
            </div>
		...
		<div id="jiangpin" style="display: none">
			<div class="form-group">
                ...
                <div class="col-sm-9">
					<label class="radio-inline">
						<input type="radio" name="prizetype_new[变化的ID]" value="physical" checked="checked" onclick="$('#p_name_new_变化的ID').html('真实');"/>真实物品
					</label>
					<label class="radio-inline">
						<input type="radio" name="prizetype_new[变化的ID]" value="virtual" onclick="$('#p_name_new_变化的ID').html('虚拟');"/>虚拟物品
					</label>
					<?php  if(is_array($creditnames)) { foreach($creditnames as $key => $credit) { ?>
					<label class="radio-inline">
						<input type="radio" name="prizetype_new[变化的ID]" value="<?php  echo $key;?>" onclick="$('#p_name_new_变化的ID').html('<?php  echo $credit;?>');"/>会员（<?php  echo $credit;?>）
					</label>
					<?php  } } ?>
					<label class="radio-inline">
						<input type="radio" name="prizetype_new[变化的ID]" value="againprize" onclick="$('#p_name_new_变化的ID').html('再来一次');"/>再来一次
					</label>
					<label class="radio-inline">
						<input type="radio" name="prizetype_new[变化的ID]" value="spaceprize" onclick="$('#p_name_new_变化的ID').html('空奖');"/>空奖
					</label>					
					<div class="help-block">奖品类型为会员（积分）、会员（余额）等时，价值金额为增送的积分或余额等积分/余额值 <span style='color:red'>空奖不保存记录</span></div>
				</div>
            </div>
			<div class="form-group">
                <label class="col-xs-12 col-sm-2 col-md-2 control-label"><span style='color:red'>*</span><span id="p_name_new_变化的ID">真实</span>价值</label>
                <div class="col-sm-4">
                    <input class="form-control" type="text" name="prizevalue_new[变化的ID]" placeholder="请填写奖品价值或积分等值">
                </div>
				<!--
				<label class="col-xs-12 col-sm-2 col-md-2 control-label"><span style='color:red'>*</span> 助力人次</label>
                <div class="col-sm-3">
                    <div class="input-group">
                        <input class="form-control" type="text" name="break_new[变化的ID]" value="10">
                        <span class="input-group-addon">人次</span>
                    </div>
                </div>
				-->
			...
			<div class="form-group">
                <label class="col-xs-12 col-sm-2 col-md-2 control-label"><span style='color:red'>*</span> 奖品等级</label>
                <div class="col-sm-4">
                    <input class="form-control" type="text" name="prizerating_new[变化的ID]" placeholder="如：一等奖，二等奖">
                </div>
				<label class="col-xs-12 col-sm-2 col-md-2 control-label"><span style='color:red'>*</span> 奖品数量</label>
                <div class="col-sm-3">
                    <div class="input-group">
                        <input class="form-control" type="text" name="prizetotal_new[变化的ID]" value="100">
                        <span class="input-group-addon">份</span>
                    </div>
                </div>							
            </div>						
            <div class="form-group">
                <label class="col-xs-12 col-sm-2 col-md-2 control-label"><span style='color:red'>*</span> 奖品名称</label>
                <div class="col-sm-4">
                    <input class="form-control" type="text"  name="prizename_new[变化的ID]" placeholder="请填写奖品名称">
                </div>
				<label class="col-xs-12 col-sm-2 col-md-2 control-label"><span style='color:red'>*</span> 中奖概率</label>
                <div class="col-sm-3">
                    <div class="input-group">
                        <input class="form-control" type="text" name="probalilty_new[变化的ID]" value="50">
                        <span class="input-group-addon">%</span>
                    </div>
                </div>
            </div>
			<div class="form-group">
                ...
                <div class="col-sm-4">
                    <div class="input-group">
                        <span class="input-group-addon">每人最多</span>
						<input class="form-control" type="text" name="prizeren_new[变化的ID]" value="0">
                        <span class="input-group-addon">个 0为不限制</span>
                    </div>
                </div>
				<label class="col-xs-12 col-sm-2 col-md-2 control-label">每天发奖</label>
                <div class="col-sm-3">
                    <div class="input-group">
                        <span class="input-group-addon">每天最多</span>
						<input class="form-control" type="text" name="prizeday_new[变化的ID]"  value="0">
                        <span class="input-group-addon">个 0为不限制</span>
                    </div>
                </div>
            </div>            
            <div class="form-group">
                <label class="col-xs-12 col-sm-3 col-md-2 control-label">奖品图片</label>
                <div class="col-sm-9">
					<?php  echo tpl_form_field_image('prizepic_new[变化的ID]','');?>
					<div class="help-block">奖品显示图片 图片大小418px X 418px</div>
				</div>
            </div>
		</div>
		...
		<div>
			<div class="form-group">
                ...
                <div class="col-sm-9">
					<label class="radio-inline">
						<input type="radio" name="prizetype_new[1]" value="physical" checked="checked" onclick="$('#p_name_new').html('真实');"/>真实物品
					</label>
					<label class="radio-inline">
						<input type="radio" name="prizetype_new[1]" value="virtual" onclick="$('#p_name_new').html('虚拟');"/>虚拟物品
					</label>
					<?php  if(is_array($creditnames)) { foreach($creditnames as $key => $credit) { ?>
					<label class="radio-inline">
						<input type="radio" name="prizetype_new[1]" value="<?php  echo $key;?>" onclick="$('#p_name_new').html('<?php  echo $credit;?>');"/>会员（<?php  echo $credit;?>）
					</label>
					<?php  } } ?>
					<label class="radio-inline">
						<input type="radio" name="prizetype_new[1]" value="againprize" onclick="$('#p_name_new').html('再来一次');"/>再来一次
					</label>
					<label class="radio-inline">
						<input type="radio" name="prizetype_new[1]" value="spaceprize" onclick="$('#p_name_new').html('空奖');"/>空奖
					</label>					
					<div class="help-block">奖品类型为会员（积分）、会员（余额）等时，价值金额为增送的积分或余额等积分/余额值 <span style='color:red'>空奖不保存记录</span></div>
				</div>
            </div>
			<div class="form-group">
                <label class="col-xs-12 col-sm-2 col-md-2 control-label"><span style='color:red'>*</span><span id="p_name_new">真实</span>价值</label>
                <div class="col-sm-4">
                    <input class="form-control" type="text" name="prizevalue_new[1]" placeholder="请填写奖品价值或积分等值">
                </div>
				<!--
				<label class="col-xs-12 col-sm-2 col-md-2 control-label"><span style='color:red'>*</span> 助力人次</label>
                <div class="col-sm-3">
                    <div class="input-group">
                        <input class="form-control" type="text" name="break_new[1]" value="10">
                        <span class="input-group-addon">人次</span>
                    </div>
                </div>
				-->
			...
			<div class="form-group">
                <label class="col-xs-12 col-sm-2 col-md-2 control-label"><span style='color:red'>*</span> 奖品等级</label>
                <div class="col-sm-4">
                    <input class="form-control" type="text" name="prizerating_new[1]" placeholder="如：一等奖，二等奖">
                </div>
				<label class="col-xs-12 col-sm-2 col-md-2 control-label"><span style='color:red'>*</span> 奖品数量</label>
                <div class="col-sm-3">
                    <div class="input-group">
                        <input class="form-control" type="text" name="prizetotal_new[1]" value="100">
                        <span class="input-group-addon">份</span>
                    </div>
                </div>							
            </div>						
            <div class="form-group">
                <label class="col-xs-12 col-sm-2 col-md-2 control-label"><span style='color:red'>*</span> 奖品名称</label>
                <div class="col-sm-4">
                    <input class="form-control" type="text"  name="prizename_new[1]" placeholder="请填写奖品名称">
                </div>
				<label class="col-xs-12 col-sm-2 col-md-2 control-label"><span style='color:red'>*</span> 中奖概率</label>
                <div class="col-sm-3">
                    <div class="input-group">
                        <input class="form-control" type="text" name="probalilty_new[1]" value="50">
                        <span class="input-group-addon">%</span>
                    </div>
                </div>
            </div>
			<div class="form-group">
                ...
                <div class="col-sm-4">
                    <div class="input-group">
                        <span class="input-group-addon">每人最多</span>
						<input class="form-control" type="text" name="prizeren_new[1]" value="0">
                        <span class="input-group-addon">个 0为不限制</span>
                    </div>
                </div>
				<label class="col-xs-12 col-sm-2 col-md-2 control-label">每天发奖</label>
                <div class="col-sm-3">
                    <div class="input-group">
                        <span class="input-group-addon">每天最多</span>
						<input class="form-control" type="text" name="prizeday_new[1]" value="0">
                        <span class="input-group-addon">个 0为不限制</span>
                    </div>
                </div>
            </div>            
            <div class="form-group">
                <label class="col-xs-12 col-sm-3 col-md-2 control-label">奖品图片</label>
                <div class="col-sm-9">
					<?php  echo tpl_form_field_image('prizepic_new[1]','');?>
					<div class="help-block">奖品显示图片 图片大小418px X 418px</div>
				</div>
            </div>
			<hr/>
...
<!--
	...
	$('#btn_add_award').bind('click', function(){
		...
		content += '<hr/>';
		content += '</div>';
		var reg=new RegExp('变化的ID','g'); //创建正则RegExp对象
		contents = content.replace(reg,k);
		$('#award_insert_flag').before(contents);
