...
<div class="panel-heading">
	<div class="row-fluid">
		<div class="span8 control-group">
			<a class="btn btn-default">请选择导出日期</a>
			<?php  load()->func('tpl');?>
			<?php  echo tpl_form_field_daterange('range', $range);?>
			<a class="btn btn-default js-pop"><i class="icon-download-alt"></i>导出SN码和兑奖信息</a>
...
<script type="text/javascript">(function ($) {
	$('.js-pop').click(function() {
		var starttime = $("[name='range[start]']").val();
		var endtime = $("[name='range[end]']").val();
		location.href="<?php  echo $this->createWebUrl('download',array('rid'=>$rid))?>" +
		"&starttime=" + starttime +
		"&endtime=" + endtime;
	});
})(jQuery);
