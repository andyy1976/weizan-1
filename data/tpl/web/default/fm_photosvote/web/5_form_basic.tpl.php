...
<div class="form-group">
	...
	<div class="col-sm-8">
		<input class="js-flag" type="checkbox" name="rstatus" radiotype = "status" <?php  if($reply['status']) { ?> checked="checked" <?php  } ?> />
		
	</div>
</div>

<div id="status" <?php  if(!$reply['status']) { ?>style="display:none"<?php  } ?>>
	<div class="form-group">
	...
	<div class="form-group">
	    <label class="col-xs-12 col-sm-2 col-md-2  control-label"><span style='color:red'>*</span> 活动时间</label>
	    <div class="col-sm-8">
	...
	<div class="form-group">
	    <label class="col-xs-12 col-sm-2 col-md-2  control-label"><span style='color:red'>*</span> 投票时间</label>
	    <div class="col-sm-8">
	...
	<div class="form-group">
	    <label class="col-xs-12 col-sm-2 col-md-2  control-label"><span style='color:red'>*</span> 报名时间</label>
	    <div class="col-sm-8">
	...
	<div class="form-group">
	    <label class="col-xs-12 col-sm-2 col-md-2 control-label"><span style='color:red'>*</span>是否开启投票倒计时</label>
	   <div class="col-sm-8">
	        <input class="js-flag" type="checkbox" name="isdaojishi" radiotype = "isdaojishi" <?php  if($reply['isdaojishi'] == 1) { ?> checked="checked"<?php  } ?>/>
	         <div class="help-block">不了解熟悉此倒计时系统的请勿开启.</div>
	    </div>
	   
	</div>
	<div id="isdaojishi" <?php  if(!$reply['isdaojishi']) { ?>style="display:none"<?php  } ?>>
		 <div class="form-group">
			<label class="col-xs-12 col-sm-2 col-md-2 control-label">用户倒计时投票时间</label>
		   	<div class="col-sm-8">
		...
		<div class="form-group">
			<label class="col-xs-12 col-sm-2 col-md-2  control-label">用户倒计时，投票时间结束提示语</label>
			<div class="col-sm-8">
				<input type="text" class="form-control" name="ttipvote" value="<?php  echo $reply['ttipvote'];?>" />
			<div class="help-block">用户倒计时，投票时间结束提示语</div>
			</div>
		</div>
	</div>
	...
	<div class="form-group">
		...
		<div class="col-sm-8">
			...
			<div class="help-block">活动详细说明，用在更多中的活动详情</div>
		</div>
	</div>
	<div class="form-group">
