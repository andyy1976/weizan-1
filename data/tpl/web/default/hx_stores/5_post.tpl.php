...
<div class="main">
	<ul class="nav nav-tabs">
		...
		<li class="active"><a href="<?php  echo $this->createWebUrl('post');?>"><?php  if(empty($item)) { ?>添加<?php  } else { ?>修改<?php  } ?>门店</a></li>
	</ul>
	<div class="panel panel-info">
		<div class="panel-heading"><?php  if(empty($item)) { ?>添加<?php  } else { ?>修改<?php  } ?>门店</div>
		<div class="panel-body">
			...
			<div class="form-group">
				...
				<div class="col-sm-8">
					<input class="form-control" name="title" id="" type="text" value="<?php  echo $item['title'];?>">
					&nbsp;&nbsp;请填写门店名称
				</div>		
			</div>
			<div class="form-group">
			...
			<div class="form-group">
				...
				<div class="col-sm-8">
					<textarea name="content" class="form-control richtext" ><?php  echo $item['content'];?></textarea>
				</div>		
			</div>
			...
			<div class="form-group">
				...
				<div class="col-sm-8">
					<input class="form-control" name="phone" id="" type="text" value="<?php  echo $item['phone'];?>">
					&nbsp;&nbsp;请填写门店电话号码
				</div>		
			</div>
			<div class="form-group">
				...
				<div class="col-sm-8">
					<input class="form-control" name="qq" id="" type="text" value="<?php  echo $item['qq'];?>">
				</div>		
			</div>
			<div class="form-group">
			...
			<div class="form-group">
				...
				<div class="col-sm-8">
					<input class="form-control" name="address" id="" type="text" value="<?php  echo $item['address'];?>">
				</div>		
			</div>
			<div class="form-group">
