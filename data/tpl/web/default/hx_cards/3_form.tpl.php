  ...
  <div class="panel panel-default">
    ...
    <div id="collapseOne" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="headingOne">
      <div class="panel-body">
        ...
        <div class="form-group">
          <label class="col-xs-12 col-sm-3 col-md-2 control-label">每人每天分享最多增加抽奖次数</label>
          <div class="col-sm-2">
            <div class="input-group">
              <input class="form-control" type="text" value="<?php  echo $reply['sharenum'];?>" class="span2" name="sharenum">
              <span class="input-group-addon">次</span>
            </div>
          </div>
        </div>
       ...
       <div class="form-group">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-9 col-xs-12">
              ...
              <span class="help-block">是否只有关注用户可以玩,需要认证服务号</span>
            </div>
        </div>
