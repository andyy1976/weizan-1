		...
		<div class="panel panel-default">
			...
			<div class="panel-body">
				...
				<div class="form-group">
					...
					<div class="col-sm-9 col-xs-12">
						<?php  echo tpl_form_field_image('picurl', $settings['picurl'])?>
					</div>
				</div>
				<div class="form-group">
					<label class="col-xs-12 col-sm-3 col-md-2 control-label">简介</label>
					<div class="col-sm-9 col-xs-12">
						<input type="text" name="info" class="form-control" value="<?php  echo $settings['info'];?>" />
					</div>
				</div>
				<div class="form-group">
					<label class="col-xs-12 col-sm-3 col-md-2 control-label">帐号</label>
					<div class="col-sm-9 col-xs-12">
						<input type="text" name="account" class="form-control" value="<?php  echo $settings['account'];?>" />
					</div>
				</div>
				<div class="form-group">
					<label class="col-xs-12 col-sm-3 col-md-2 control-label">密码</label>
					<div class="col-sm-9 col-xs-12">
						<input type="text" name="pwd" class="form-control" value="<?php  echo $settings['pwd'];?>" />
					</div>
				</div>					
			</div>
		</div>
