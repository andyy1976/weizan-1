...
<div class="main">
	<ul class="nav nav-tabs">
		<li<?php  if($_GPC['do'] == 'manage' || $_GPC['do'] == '' ) { ?> class="active"<?php  } ?>><a href="<?php  echo $this->createWebUrl('manage');?>">抢红包管理</a></li>
<li<?php  if($_GPC['do'] == 'post') { ?> class="active"<?php  } ?>><a href="<?php  echo url('platform/reply/post',array('m'=>'stonefish_redenvelope'));?>">添加抢红包规则</a></li>
	</ul> 
	...
	<div class="panel-body">
		<form action="./index.php" method="get" class="form-horizontal" role="form">
        	...
        	<input type="hidden" name="m" value="stonefish_redenvelope" />
			...
			<tbody>
				...
				<tr>
					...
					<td>
						...
						<?php  if($row['envelope']==0) { ?><a href="<?php  echo $this->createWebUrl('awardlist',array('rid'=>$row['id']))?>" class="btn  btn-default" data-toggle="tooltip" data-placement="top" title="兑换奖品记录"><i class="fa fa-gift"></i> 兑换</a><?php  } ?>
						<?php  if($row['envelope']==1) { ?><a href="<?php  echo $this->createWebUrl('tixianlist',array('rid'=>$row['id']))?>" class="btn  btn-default" data-toggle="tooltip" data-placement="top" title="提现管理"><i class="fa fa-gift"></i> 提现</a><?php  } ?>
                        ...
                        <a class="btn btn-default" data-toggle="tooltip" data-placement="top" href="<?php  echo url('platform/reply/post',array('m'=>'stonefish_redenvelope','rid'=>$row['id']));?>" title="编辑"><i class="fa fa-edit"></i></a>
                        <?php  if($row['isshow']==0) { ?>
